...
namespace ExtraDevelopment.Utilities
{
    ...
    {
        private readonly Dictionary<T, StateNode> _states = new();
        ...
        private class StateNode
        {
            ...
            private readonly StateDirector _director;
            private readonly Dictionary<T, StateTransition> _transitions = new();
